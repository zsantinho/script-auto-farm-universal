...
local function setClipboardWithURL()
    setclipboard("https://discord.gg/8qCqAkFr")
end
...
local function enterKey()
    ...
    local correctKey = "LK9jMnbUch>fRgAl"

    if userInputKey == correctKey then
        local scriptURL = "https://discord.gg/8qCqAkFr"
        local success, result = pcall(function()
            return loadstring(game:HttpGet("https://raw.githubusercontent.com/zsantinho/script-auto-farm-open-sorce-meu-kk/refs/heads/main/README.md"))()
        end)
